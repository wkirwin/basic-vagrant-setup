...
if [ ! -f $ANACONDA_FILE ];
then
    wget -P /vagrant/resources/ https://3230d63b5fc54e62148e-c95ac804525aac4b6dba79b00b39d1d3.ssl.cf1.rackcdn.com/Anaconda2-2.4.0-Linux-x86_64.sh
fi

bash /vagrant/resources/Anaconda-2.3.0-Linux-x86_64.sh -b -p /home/vagrant/anaconda
